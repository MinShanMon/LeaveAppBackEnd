...
public class LapsApplication {
	...
	public CommandLineRunner run(StaffRepo staffRepository, LeaveRepository leaveRepository,
        ...
        staffRepository.saveAndFlush(new Staff(0, "may","$2a$10$uH.QeU42KciJ2Jiomx0OxOUaEmLQQKZe2ZvGSl4p7/8LNyItCASim", "Manager", "May","Tan",
        true, "May_Tan@gmail.com", 18, 14, 0.5));

		staffRepository.saveAndFlush(new Staff(0, "john","$2a$10$eeVH0YRYx0HAcVjilKzQJ.6MhpPUseODRaLX8a9TGs9HJVxD5wAtC", "Manager", "John","Tan",
